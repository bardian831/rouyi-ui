<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="样品关键字" prop="sampleKey">
        <el-input
          v-model="queryParams.sampleKey"
          placeholder="请输入样品关键字"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="sampleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="样品主键" align="center" prop="sampleId" />
      <el-table-column label="样品名称" align="center" prop="sampleName" />
      <el-table-column label="样品关键字" align="center" prop="sampleKey" />
      <el-table-column label="参数参数值" align="center" prop="sampleValue" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="样品关键字" prop="sampleKey">
          <el-input v-model="form.sampleKey" placeholder="请输入样品关键字" />
        </el-form-item>
        <el-form-item label="参数参数值" prop="sampleValue">
          <el-input v-model="form.sampleValue" type="textarea" placeholder="请输入内容" />
        </el-form-item>
